		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#nttdataemployees-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nttdataemployees-display": {
								"semanticObject": "nttdataemployees",
								"action": "display",
								"description": "Employees application.",
								"title": "App Title",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=nttdata.employees",
									"url": sap.ui.require.toUrl("nttdata/employees")
								}
							}
						}
					}
